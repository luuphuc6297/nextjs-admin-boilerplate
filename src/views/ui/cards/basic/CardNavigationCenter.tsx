                ...
                <CardContent sx={{ textAlign: 'center' }}>
                    <TabPanel value="1" sx={{ p: 0 }}>
                        ...
                        <Typography variant="body2" sx={{ mb: 4 }}>
                            Pudding tiramisu caramels. Gingerbread gummies danish chocolate bar
                            toffee marzipan. Wafer wafer cake powder danish oat cake.
                        </Typography>
                    ...
                    <TabPanel value="3" sx={{ p: 0 }}>
                        ...
                        <Typography variant="body2" sx={{ mb: 4 }}>
                            Icing cake macaroon macaroon jelly chocolate bar. Chupa chups dessert
                            dessert soufflé chocolate bar jujubes gummi bears lollipop.
                        </Typography>
